...
export default {
  ...
  theme: {
    ...
    {'home': "linear-gradient(90deg, rgba(4, 37, 52, 0.56) 0%, rgba(4, 37, 52, 0) 101.02%), url('/remote-camp-modular-buildings-exterior.jpg')",
      ...
      'case-5':"linear-gradient(90deg, rgba(4, 37, 52, 0.4) 0%, rgba(4, 37, 52, 0) 101.02%),url('/clean-harbors-ruth-lake-lodge-evening.jpg')",
      'case-6':"linear-gradient(90deg, rgba(4, 37, 52, 0.4) 0%, rgba(4, 37, 52, 0) 101.02%),url('/aerial-atkinson-road-camp.jpg')",
      'case-7':"linear-gradient(90deg, rgba(4, 37, 52, 0.4) 0%, rgba(4, 37, 52, 0) 101.02%),url('/entrance-lobby-permian-lodging-camp-lobby.jpg')",
      'case-8':"linear-gradient(90deg, rgba(4, 37, 52, 0.4) 0%, rgba(4, 37, 52, 0) 101.02%),url('/right-choice-camps-catering-aerial.jpg')",
      'case-9':"linear-gradient(90deg, rgba(4, 37, 52, 0.4) 0%, rgba(4, 37, 52, 0) 101.02%),url('/case-studies-no9.jpg')",
      'case-10':"linear-gradient(90deg, rgba(4, 37, 52, 0.4) 0%, rgba(4, 37, 52, 0) 101.02%),url('/sodexo-canada-keeyask-lobby.jpg')",
      'case-11':"linear-gradient(90deg, rgba(4, 37, 52, 0.4) 0%, rgba(4, 37, 52, 0) 101.02%),url('/hydroelectric-project-canada.jpg')",
