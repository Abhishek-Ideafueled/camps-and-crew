...
const MiningTechnology = () => {


  return (
    <div className='w-full max-h-max pb-5 md:pb-0'>
      <div className='grid grid-cols-1 md:grid-cols-2 h-full items-center px-3 md:px-0'>
            <div className='w-full md:min-h-[550px] max-h-[636px] h-full'>
                ...
                src="dump-truck-hauling-rock-open-pit-mine.jpg" alt="Haul truck drives up hill in open pit mine" />
            </div>
...
export default MiningTechnology
