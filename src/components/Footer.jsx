...
const Footer = () => {
  return (
    <div className='w-full bg-[#181C20] text-white'>
      <div className='pt-14 pb-20 px-28 flex justify-between items-start flex-wrap gap-6'>
        ...
        <p className='text-sm text-[#CAD5DE]'>Camps & Crew simplifies crew and lodge management, partnering with housing providers, energy, and mining companies to streamline operations and reduce costs.</p>
        </div>
