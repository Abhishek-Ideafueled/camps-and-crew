  ...
  return (
    <div className="w-full relative bg-[#FCFBF8]" >
      <div className="main-container mx-auto py-10 lg:py-20 flex flex-col gap-[60px]">
        <h2 className="self-center heading-h2 border-b-[8px] border-b-custom-button text-center w-[75%] sm:max-w-fit sm:w-auto">
          Housekeeping and Maintenance
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 lg:gap-8 z-10">
          ...
          {housekeepingArr.map((item) => (
            <div
              key={item.id}
              className="flex flex-col gap-[30px] md:gap-[60px] py-6 px-4 md:px-6 md:py-8 bg-white"
            >
              <span>
