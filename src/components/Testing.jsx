    ...
    <div className=''>
     ...
     <div className="main-container mx-auto relative rw-history-card overflow-hidden no-scrollbar ">
            ...
            <div className='relative w-full h-auto'>
                ...
                src="/fifo-worker-views-mobile-phone-bus-transport.png"
                 alt="Front desk receptionist at mining housing facilities studies computer screen." />
                 <div className='absolute inset-0 bg-card-gradient2 rounded-lg h-full w-full'></div>
            </div>
        </div>
            ...
            <div className='relative w-full h-auto'>
                <img 
                className='rounded-lg object-cover w-full h-auto'
                src="/camp-cleaning-attendant-views-ipad.png"
...
{/*              
          ...
          <div className="main-container mx-auto my-[17px] rw-year-nav h-auto">
            ...
            >
              ...
              <SwiperSlide
                ...
                >
                  <div className={`py-4 swiper-no-swiping text-center text-base leading-[30px] lg:text-xl lg:leading-[32px] cursor-pointer font-ttCommonProRegular ${year === years[currIndex] ? "font-semibold text-[#10688E]" :"font-normal"}  text-[#3D7F9E]`}>{ year} </div>
                </SwiperSlide>
              ))}
