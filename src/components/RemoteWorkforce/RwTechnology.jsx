...
const RwTechnology = () => {
    ...
    const technologyArr = [
        {
            id:1,
            iconUrl:"/increase-efficiency-remote-camp-icon.png",
            heading:"Increase Operational Efficiency",
            desc:"Streamline core operations, like front desk, cleaning and billing, across your camps or villages. Reduce time spent on routine tasks to increase overall productivity."
        },
        {
            id:2,
            iconUrl:"/guest-satisfaction-icon.png",
            heading:"Enhance Guest Satisfaction",
            desc:"Elevate service levels to provide a seamless and comfortable stay, ensuring workers are well-rested and productive before their shifts."
        },
        {
            id:3,
            iconUrl:"/camp-safety-icon.png",
            heading:"Elevate Safety Standards",
            desc:"Maintain an accurate headcount of all camp residents on-site at all times. Gain access to technology designed to streamline your emergency response procedures."
        },
        {
            id:4,
            iconUrl:"/data-securit-icon.png",
            heading:"Secure Data Management",
            desc:"Protect sensitive guest and operational data with advanced security protocols. Ensure privacy and compliance with regulatory standards."
        },
        {
            id:5,
            iconUrl:"/revenue-growth-camp-managment-services-icon.png",
            heading:"Drive Revenue Growth",
            desc:"Maximize room utilization and streamline billing processes. Leverage detailed analytics to identify revenue-enhancing opportunities."
        },
        {
            id:6,
            iconUrl:"/reduce-overhead-costs-icon.png",
            heading:"Reduce Overhead Costs",
            desc:"Reduce costs by streamlining administrative tasks, improving facilities management, and reducing food waste via improved occupancy forecasting."
        },
  ...
  return (
    <div className='w-full bg-[#FCFBF8]'>
        <div className='main-container mx-auto py-10 lg:py-20 flex flex-col gap-[30px] lg:gap-[60px] items-center'>
            ...
            <h2 className='heading-h2 max-w-[600px]'>
            Technology to Elevate Your
...
<line y1="-0.5" x2="18.0278" y2="-0.5" transform="matrix(-0.5547 0.83205 0.83205 0.5547 144.5 1)" stroke="#647787"/>
            ...
            Designed to boost operational and commercial performance, our technology helps workforce 
            accommodations providers deliver top-notch service to their clients and camp residents.
            </span>
            </div>
