...
const B2GoldHero = () => {
  return (
    ...
    <div className="w-full bg-custom-back h-[700px] smalls:h-[700px] md:h-[700px] lg:h-[450px] pt-10">
 <div className="flex flex-col-reverse lg:gap-8 lg:flex-row main-container w-full mx-auto">
   <div className="relative b2gold cs-back-image">
     <div className="lg:absolute scLg:static scLg:w-[526px] bg-cs-hero-img4  bg-cover lg:bg-contain min-w-[300px] lg:w-[1000px] h-[300px] md:min-h-[450px] lg:h-[500px] top-[0px] bottom-0 right-0 rounded-2xl bg-no-repeat"></div>
   </div>
   ...
   <div className="flex flex-col max-w-[600px] xl:max-w-[800px] xl:min-w-[700px] items-center self-start py-5">
     <div className="flex flex-col lg:h-[344px] w-full">
       ...
       <div className="grid grid-cols-1 md:grid-cols-3 justify-between gap-4 md:gap-6 scLg:gap-[50px]">
   ...
   <div className="w-full bg-[#5BC0ED] py-10 h-[240px] lg:h-[140px]">
     <div className="main-container hidden lg:flex mx-auto scLg:gap-8">
       ...
       <div className="grid grid-cols-1 md:grid-cols-3 justify-between gap-4 md:gap-6 xl:gap-[75px] scLg:gap-[50px]">
         <div className="flex flex-col">
