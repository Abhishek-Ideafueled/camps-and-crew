      ...
      <div className="main-container mx-auto py-10 lg:py-20">
        <div className="flex flex-col gap-[60px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className=" flex flex-col items-center md:max-w-[336px] lg:max-w-[456px] xl:max-w-[636px]">
              <div className=" flex flex-col gap-10 bg-[#EAE8E3] px-6 lg:px-14 pt-6 lg:pt-14 pb-28 rounded-2xl">
                ...
                <button className="btn-orange w-[219px] h-[58px] rounded">
                  SEE ALL FEATURES
                </button>
              </div>
            </div>
            <div className="flex flex-col items-center md:max-w-[336px] lg:max-w-[456px] xl:max-w-[636px] z-10">
              <div className="flex flex-col gap-10 bg-[#EAE8E3] px-6 lg:px-14 pt-6 lg:pt-14 pb-28 rounded-2xl">
              ...
              <div className="relative mt-[-70px] px-14 w-full h-full">
                <img
                  ...
                  alt=""
                />
                <div className="relative top-[50%] md:bottom-[-50px] lg:bottom-[-100px] flex justify-center items-center h-full opacity-80">
                  <Link to="#">
                    <svg
                      width="80"
                      height="80"
