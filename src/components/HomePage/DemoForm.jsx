...
const DemoForm = () => {
  return (
    ...
    <div className='py-20 px-4 md:px-28 xl:px-0 w-full xl:max-w-[1216px] mx-auto '>
      ...
      <div className='p-4 lg:p-10 min-h-[786px] flex flex-col md:flex-row justify-center items-center '>  
                ...
                <div className=' bg-[#00000033] backdrop-blur-sm max-w-[488px] sm:w-[488px] lg:w-[488px] py-10 px-5 lg:py-9 lg:px-9  rounded-2xl'>
