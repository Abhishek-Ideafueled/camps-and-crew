    ...
    <div className='py-20 px-28 xl:px-0 w-full xl:max-w-[1216px] mx-auto '>
      ...
      <div className='p-10 h-[786px] flex justify-center'>  
                <div className='flex flex-col w-[590px] gap-2 right-4 items-center justify-center'>
                    <h2 className='text-[44px] text-custom-button font-gilroyBold font-normal leading-[3.3rem]'>Streamline the Management of your Remote Operations</h2>
                ...
                <span className='flex items-center gap-4'><FaHelmetSafety />
                <input type="text" placeholder='Select Products of Interest' className='border-none outline-none text-black w-[324px] cursor-pointer' disabled/></span>
                <IoIosArrowDown />
                </div>
                <div className='bg-white flex py-3 px-4 border-[1px] border-[#D0D5DD] gap-3 text-[#43597A] rounded-lg'>
                <BiSolidMessage />
