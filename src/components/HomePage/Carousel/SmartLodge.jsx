    ...
    <div className="banner-slider overflow-hidden">
      <Slider {...settings}>
        <div className="relative min-h-[400px] sm:min-h-[550px] lg:min-h-[620px] text-white w-full">
          <div className="absolute inset-0 h-auto bottom-0 bg-home img-container"></div>
          <div
            className="min-h-[400px] sm:min-h-[550px] lg:min-h-[620px] flex items-center justify-center"
            data-aos="fade-up"
              ...
              >
                <div className="flex flex-col gap-[10px] slider-heading">
                  ...
                  <h1 className="text-[26px] md:text-[37px] lg:text-h1 font-gilroyBold font-normal lg:leading-[3.6rem] max-w-[600px]">
                    The most flexible camp <br /> management system <br /> on
                    the market
                  </h1>
                </div>
               <Link to="/software-for-workforce-camp"> <div className="max-w-[219px] h-[54px] flex items-center justify-center btn-orange text-center leading-[0.9rem] text-sm lg:text-base rounded-[4px] lg:leading-[1.55rem] slider-desc">
            ...
            <div className="relative main-container mx-auto">
              <div className="flex flex-col gap-8 w-full" data-animate="bottom">
                <div className="flex flex-col gap-[10px]">
                  ...
                  <h1 className="text-[26px] md:text-[37px] lg:text-h1 font-gilroyBold font-normal  lg:leading-[3.6rem] max-w-[600px]">
                    Maximize room <br /> utilization before <br /> you buy,
                    build or rent
                  </h1>
                </div>
                <Link to="/software-for-workforce-camp">
                
                  <div className="max-w-[219px] h-[54px] flex items-center justify-center btn-orange text-center leading-[0.9rem] text-sm lg:text-base rounded-[4px] lg:leading-[1.55rem]">
                    SEE ALL FEATURES
                  </div>
                </Link>
              </div>
            ...
            <div className="relative main-container mx-auto">
              ...
              >
                <div className="flex flex-col gap-[10px]">
                  ...
                  <h1 className="text-[26px] md:text-[37px] lg:text-h1 font-gilroyBold font-normal lg:leading-[3.6rem] max-w-[600px]">
                    Easy-to-use tools <br /> to book and assign <br /> rooms at
                    your camp
                  </h1>
                </div>
               <Link to="/software-for-workforce-camp">  <div className="max-w-[219px] h-[54px] flex items-center justify-center btn-orange text-center rounded-[4px] leading-[0.9rem] text-sm lg:text-base lg:leading-[1.55rem]">
            ...
            <div className="relative main-container mx-auto">
              <div className="flex flex-col gap-8 w-full" data-animate="bottom">
                <div className="flex flex-col gap-[10px]">
                  ...
                  <h1 className="text-[26px] md:text-[37px] lg:text-h1 font-gilroyBold font-normal lg:leading-[3.6rem] max-w-[600px]">
                    Technology to help <br /> your staff turn rooms <br />{" "}
                    faster than ever
                  </h1>
                </div>
                <Link to="/software-for-workforce-camp"> <div className="max-w-[219px] h-[54px] flex items-center justify-center btn-orange text-center rounded-[4px] leading-[0.9rem] text-sm lg:text-base lg:leading-[1.55rem]">
            ...
            <div className="relative main-container mx-auto">
              <div className="flex flex-col gap-8 w-full" data-animate="bottom">
                <div className="flex flex-col gap-[10px] slider-heading">
                  ...
                  <h1 className="text-[26px] md:text-[37px] lg:text-h1 font-gilroyBold font-normal lg:leading-[3.6rem] max-w-[600px]">
                    Designed to manage <br /> camps large or small, <br /> in
                    any location
                  </h1>
                </div>
                <div className="max-w-[219px] h-[54px] flex items-center justify-center btn-orange text-center rounded-[4px] text-sm lg:text-base lg:leading-[1.55rem] slider-desc">
                  <Link to="/software-for-workforce-camp">
