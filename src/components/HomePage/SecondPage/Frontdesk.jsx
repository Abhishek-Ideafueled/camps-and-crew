...
const Frontdesk = () => {
  return (
    ...
    <div className=" flex flex-col lg:px-10 p-6 lg:py-16 min-h-[300px]  max-w-[492px] lg:max-w-[645px]">
     ...
     <button className='bg-custom-button hover:bg-btn-hover mt-4 max-w-[179px] h-[54px] rounded-[4px] font-ttCommonProNormal font-semibold text-[#060F1F] text-sm md:text-base  md:leading-[1.6rem]'>
      LEARN MORE</button>
      </div>
    {/* </div> */}
