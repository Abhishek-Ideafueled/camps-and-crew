...
const RoomsManagement = () => {
  return (
    <div className="flex items-center shadow-lg lg:w-[1216px] xl:w-full xl:mx-auto h-[465px] rounded-2xl">
    ...
    <div className="w-1/2 h-[465px]  rounded-2xl">
      <img src={girlreading} alt="girl reading image" className='w-full h-full object-cover rounded-2xl'/>
    </div>
  </div>
  )
}
