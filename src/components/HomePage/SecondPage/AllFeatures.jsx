...
const AllFeatures = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 h-[526px] gap-5">
      <div className='flex flex-col w-[340px] h-[265px] rounded-xl border-[1px] border-[#63C1EC] py-10 px-5 gap-4'>
        ...
        <ul className='flex flex-col gap-4 font-ttCommonProNormal'>
            <li className='flex items-center gap-5'><CiCircleCheck size={25} className="text-[#63C1EC]" />
      ...
      <div className='flex flex-col w-[340px] h-[265px] rounded-xl border-[1px] border-[#63C1EC] py-10 px-5 gap-4'>
        ...
        <ul className='flex flex-col gap-4 font-ttCommonProNormal'>
            <li className='flex items-center gap-5'><CiCircleCheck size={30} className="text-[#63C1EC] wid" />
            <span className="text-custom-body text-sm leading-[1.4rem]">
            Track meal allowances manually or via key swipes
            </span></li>
            <li className='flex items-center gap-5'><CiCircleCheck size={30} className="text-[#63C1EC]" />
            <span className="text-custom-body text-sm leading-[1.4rem]">
      ...
      <div className='flex flex-col w-[340px] h-[265px] rounded-xl border-[1px] border-[#63C1EC] py-10 px-5 gap-4'>
        ...
        <ul className='flex flex-col gap-4 font-ttCommonProNormal'>
            <li className='flex items-center gap-5'><CiCircleCheck size={40} className="text-[#63C1EC]" />
            <span className="text-custom-body text-sm leading-[1.4rem]">
       ...
       <div className='flex flex-col w-[340px] h-[265px] rounded-xl border-[1px] border-[#63C1EC] py-10 px-5 gap-4'>
        ...
        <ul className='flex flex-col gap-4 font-ttCommonProNormal'>
            <li className='flex items-center gap-5'><CiCircleCheck size={35} className="text-[#63C1EC]" />
            <span className="text-custom-body text-sm leading-[1.4rem]">
      ...
      <div className='flex flex-col w-[340px] h-[265px] rounded-xl border-[1px] border-[#63C1EC] py-10 px-5 gap-4'>
        ...
        <ul className='flex flex-col gap-4 font-ttCommonProNormal'>
            <li className='flex items-center gap-5'><CiCircleCheck size={45} className="text-[#63C1EC]" />
            <span className="text-custom-body text-sm leading-[1.4rem]">
      ...
      <div className='flex flex-col bg-custom-heading w-[340px] h-[265px] rounded-xl border-[1px] border-[#63C1EC] py-10 px-5 gap-8'>
            <h3 className='text-h3 text-white font-gilroyBold leading-7 font-normal'>See everything SmartLodge has to offer.</h3>
            <button className='bg-custom-button font-ttCommonProNormal font-semibold leading-[1.6rem] w-[248px] py-[19px] rounded-[4px]'>TAKE ME TO SMARTLODGE</button>
      </div>
    </div>
  )
}
