  ...
  return (
    <div className="main-container mx-auto">
      ...
      <div className="flex flex-col justify-center items-center gap-4">
        ...
        className="text-[30px] md:text-[32px] lg:text-[40px] text-custom-heading font-gilroyBold font-bold leading-[3rem]">
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-12 mx-auto md:max-w-[696px] lg:max-w-full' >
        <div className='flex flex-col h-full justify-between max-w-[584px]'  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
       ...
       {/* <div className='bg-integrated-img rounded-b-xl bg-center min-h-[300px]'></div> */}
        ...
        <div className='flex flex-col h-full justify-between max-w-[584px]' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
       ...
       {/* <div className='bg-oil-gas rounded-b-xl bg-center min-h-[300px]'></div> */}
        ...
        <div className='flex flex-col h-full justify-between max-w-[584px]' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
            <div className='flex flex-col gap-4   p-6 lg:p-10 rounded-t-xl border-[#D0D5DD] border-t-[1px] border-r-[1px] border-l-[1px]'>
       ...
       {/* <div className='bg-mining rounded-b-xl bg-center min-h-[300px]'></div> */}
        ...
        <div className='flex flex-col h-full justify-between max-w-[584px]' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
            <div className='flex flex-col gap-4  p-6 lg:p-10  rounded-t-xl border-[#D0D5DD] border-t-[1px] border-r-[1px] border-l-[1px]'>
